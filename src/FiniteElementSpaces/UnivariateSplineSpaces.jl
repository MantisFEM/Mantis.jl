...
- `polynomials::CanonicalSpaces.Bernstein`: Refence Bernstein polynomials.
"""
struct BSplineSpace<:AbstractFiniteElementSpace{1}
    knot_vector::KnotVector
    extraction_op::ExtractionOperator
    polynomials::CanonicalSpaces.Bernstein
    ...
    function BSplineSpace(patch_1d::Mesh.Patch1D, polynomial_degree::Int, regularity::Vector{Int})
        ...
        new(knot_vector, extract_bspline_to_bernstein(knot_vector), CanonicalSpaces.Bernstein(polynomial_degree))
    end
end
...
- `bspline::BSplineSpace`: A univariate B-Spline function space.
# Returns
- `::CanonicalSpaces.Bernstein`: Bernstein polynomials.
"""
