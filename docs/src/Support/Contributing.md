...
of the following:
 ...
 2. A bug report, which you can read more about [here](./SubmitBugReport.md).
...
#### New feature
 ...
 1. Part of the commits in this case will be identified by `feat:`. It's okay to make a
    ...
    feature, but consider breaking it apart into smaller `feat: add foo feature 1`, `feat: add foo feature 2`, ..., commits if you think it will help comprehension.
...
#### Bug fix
 ...
 1. Hopefully your contribution here will be small, so it should in principle fit under a
    ...
    separate them into different commits: `fix: add missing variable 1`, `fix: correct parameter type 2`, for example.
